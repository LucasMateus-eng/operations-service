...
func (m *MockReading) GetById(ctx context.Context, id int) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriting) Create(ctx context.Context, u *user.User) (int, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockRepository) Create(ctx context.Context, u *user.User) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, u)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
...
// Create mocks base method.
func (m *MockUseCase) Create(ctx context.Context, u *user.User) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, u)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
...
// GetById mocks base method.
func (m *MockUseCase) GetById(ctx context.Context, id int) (*user.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetById", ctx, id)
	ret0, _ := ret[0].(*user.User)
	ret1, _ := ret[1].(error)
