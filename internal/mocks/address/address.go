...
// Source: address/address.go
//
// Generated by this command:
//
//	mockgen -source=address/address.go -destination=internal/mocks/address/address.go -package=mocks
//
...
import (
	...
	address "github.com/LucasMateus-eng/operations-service/address"
...
func (mr *MockWritingMockRecorder) Create(ctx, a any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockWriting)(nil).Create), ctx, a)
}
...
func (m *MockWriting) Update(ctx context.Context, a *address.Address) error {
	m.ctrl.T.Helper()
...
func (mr *MockWritingMockRecorder) Update(ctx, a any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockWriting)(nil).Update), ctx, a)
}
...
// Update mocks base method.
func (m *MockRepository) Update(ctx context.Context, a *address.Address) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, a)
	ret0, _ := ret[0].(error)
	return ret0
...
// Create indicates an expected call of Create.
func (mr *MockUseCaseMockRecorder) Create(ctx, a any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockUseCase) Update(ctx context.Context, a *address.Address) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, a)
	ret0, _ := ret[0].(error)
	return ret0
...
// Update indicates an expected call of Update.
func (mr *MockUseCaseMockRecorder) Update(ctx, a any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
